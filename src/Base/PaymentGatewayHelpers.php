...
use Xgenious\Paymentgateway\Base\Gateways\AwdPay;
...
use Xgenious\Paymentgateway\Base\Gateways\CoinPayment;
...
use Xgenious\Paymentgateway\Base\Gateways\Sslcommerz;
...
use Xgenious\Paymentgateway\Base\Gateways\YooMoneyPay;
...
class PaymentGatewayHelpers
{
    ...
    public function airwallex() : AirwallexPay
    {
        return new AirwallexPay();
    }
    public function adyen() : AdyenPay
    {
        return new AdyenPay();
    }
